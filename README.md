...
🔹 Project 1: Intro – ASCII to Binary Converter <br>
...
- Basic input/output (fgets, printf) <br>
 ...
 <br> <br>
 🔹 Project 2: Translate (Custom Language Interpreter) <br>
...
- Modular program design <br>
 ...
 <br> <br>
🔹 Project 3: Dungeon Game (Graph-Based Adventure) <br>
...
- Game state management <br>
 ...
 <br> <br>
🔹 Project 4: Reverse Polish Notation (RPN) Evaluator <br>
...
- Function calls and memory usage <br>
 ...
 <br> <br>
🔹 Project 5: Tiny Shell with Job Control <br>
...
- Unix/Linux systems programming <br>
 ...
 <br> <br>
🔹 Project 6: Thread-Safe Data Structures <br>
